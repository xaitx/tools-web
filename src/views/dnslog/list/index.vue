	...
	<div class="system-dic-container layout-padding">
		<el-card shadow="hover" class="layout-padding-auto">
			...
			<el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%" >
				...
				<el-table-column prop="time" label="请求时间" show-overflow-tooltip></el-table-column>
...
// 引入组件
const DicDialog = defineAsyncComponent(() => import('/@/views/dnslog/list/dialog.vue'));
...
// 删除字典
const onRowDel = (row) => {
	ElMessageBox.confirm(`此操作将永久删除字典名称：“${row.ip}”，是否继续?`, '提示', {
