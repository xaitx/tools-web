	...
	<div class="system-dic-container layout-padding">
		<el-card shadow="hover" class="layout-padding-auto">
			...
			<el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%" @row-dblclick="onOpenInfo">
                ...
                <el-table-column prop="client" label="客户端" show-overflow-tooltip></el-table-column>
                <el-table-column prop="request" label="请求" show-overflow-tooltip></el-table-column>
...
const getTableData = () => {
    ...
    for(let i =0 ; i< 10;i++){
        data.push({
                ...
                client:"Windows",
                request:"POST",
                data: '{"cookie":"","session":"sssssssss","a":"a"}'
            })
    }
